...
const Test = () => {
  ...
  const questions = [
    `1. ${ username }님은 책임감 있는 사람인가요?`,
    `2. ${ username }님은 성실하고 사람들과 협동을 잘하는 사람인가요?`,
    `3. ${ username }님은 사람에 대해 뛰어난 통찰력을 가진 사람인가요?`,
    `4. ${ username }님은 독립적이며 혼자서 행동하는 일을 두려워하지 않는 편인가요?`,
    `5. ${ username }님은 낯선 상황에도 적응력이 뛰어난 사람인가요?`,
    `6. ${ username }님은 마음이 따듯하고 겸손한 사람인가요?`,
    `7. ${ username }님은 상대방의 이야기를 경청하는 사람인가요?`,
    `8. ${ username }님은 불공평한 일을 마주했을 때 해결책을 제시하는 사람인가요?`,
    `9. ${ username }님은 돌직구를 잘던지는 편인가요?`,
    `10. ${ username }님은 모임에서 분위기를 띄우는 사람인가요?`,
    `11. ${ username }님은 새로운 친구 사귀는걸 좋아합니까?`,
    `12. ${ username }님은 논쟁하기를 좋아합니까?`,
    `13. ${ username }님은 사무적이고, 현실적인 스타일입니까?`,
    `14. ${ username }님은 타인에게 봉사를 하는 편입니까?`,
    `15. ${ username }님은 공감능력이 좋고 고민상담을 잘해주는 편입니까?`,
    `16. ${ username }님은 팀플 할 때 자기 계획대로 직접 이끌어야 직성이 풀리는 편입니까?`,
